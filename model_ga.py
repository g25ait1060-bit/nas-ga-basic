...
class GeneticAlgorithm:
    ...
    def evaluate_fitness(self, architecture, train_loader, val_loader, device, epochs=100):
        ...
        # NEW: Weighted model complexity penalty
            ...
            # Assign realistic compute-based weights
            w_conv = 0.05   # Conv parameters penalized more (compute heavy)
            w_fc = 0.01     # FC parameters lighter penalty

            # Normalize penalties
            conv_penalty = (conv_params / 1e6) * w_conv
            fc_penalty = (fc_params / 1e6) * w_fc
    ...
    # Ensure fitness values are positive (shift if needed)
